...
import { createUser } from "@/app/dashboard/staff/actions";
import {
  Dialog,
  DialogContent,
  DialogDescription,
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[600px]">
        <DialogHeader>
          ...
          <DialogDescription>
            Add a new user or guardian to the system.
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="space-y-4 py-4">
          ...
          <div className="space-y-2">
            ...
            <select
              ...
              value={formData.role}
              onChange={(e) =>
                setFormData({ ...formData, role: e.target.value as "user" | "guardian" })
              }
